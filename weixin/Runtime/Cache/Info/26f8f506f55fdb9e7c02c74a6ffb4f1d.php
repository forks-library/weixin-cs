...
<!-- 没有数据时，隐藏封面 -->
<section class="main-container block" style="padding-top:3.5rem;padding-bottom:3.5rem; font-size:0px;">
	<!-- 头部 -->
	...
	<div class="article-title inline-block">
		<div class="article-title-txt">晒账单</div>
	</div>
	<!--列表内容-->
	<ul class="paybill-list margint-05rem"></ul>
</section>
<!--等待加载-->
...
<script type="text/javascript">
    ...
    // 微信授权
	window._wxAuthUrl = "<?php echo urlencode(base64_encode(U('/dgcs_wx/weixin.php/info/paybill/index?id=ot7VhxPwYRRkgGu3CUiXASCYo4k0'))); ?>";
