...
<!-- 没有数据时，隐藏封面 -->
<section class="main-container block" style="padding-top:7.2rem;padding-bottom:3.5rem; font-size:0px;">
	<!-- 头部 -->
...
<script type="text/javascript">
    ...
    // 微信授权
	window._wxAuthUrl = "<?php echo urlencode(base64_encode(U('/dgcs_wx/weixin.php/info/aboutus/charitablepage?id=ot7VhxHAtdjm_LxgGYeSKfL_H2Is&no=230201709071059599229'))); ?>";
