...
<section class="main-container block" style="padding-top:6.5rem;padding-bottom:3.5rem; font-size:0px;">
	...
	<div class="article-onetitle">
		<div class="article-onetitle-txt ellipsis" style="width: 100%">慈善项目</div>
	</div>
	<!--列表-->
	<div class="article-cont" style="padding-top: 0rem;padding-bottom: 0rem;">
...
<script type="text/javascript">
    ...
    // 微信授权
	window._wxAuthUrl = "<?php echo urlencode(base64_encode(U('/dgcs_wx/weixin.php/info/aboutus/charitable?id=ot7VhxPwYRRkgGu3CUiXASCYo4k0'))); ?>";
