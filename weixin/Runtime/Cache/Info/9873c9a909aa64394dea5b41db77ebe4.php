...
<section class="main-container block" style="padding-top:6.5rem;padding-bottom:4rem; font-size:0px;">
	...
	<div class="article-onetitle">
		<div class="article-onetitle-txt ellipsis" style="width: 100%">慈善动态</div>
	</div>
	<!--列表-->
...
<script type="text/javascript">
    ...
    // 微信授权
	window._wxAuthUrl = "<?php echo urlencode(base64_encode(U('/dgcs_wx/weixin.php/info/aboutus/dynamiclist?id=ot7VhxPwYRRkgGu3CUiXASCYo4k0'))); ?>";
