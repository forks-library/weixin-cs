...
<!-- 没有数据时，隐藏封面 -->
<section class="main-container block" style="padding-top:6.5rem;padding-bottom:4rem; font-size:0px;">
	<!-- 头部 -->
	...
	<div class="article-onetitle">
		<div class="article-onetitle-txt ellipsis" style="width: 100%">慈善法规</div>
	</div>
	<!--列表-->
...
<script type="text/javascript">
    ...
    // 微信授权
	window._wxAuthUrl = "<?php echo urlencode(base64_encode(U('/dgcs_wx/weixin.php/info/aboutus/statutelist?id=ot7VhxHAtdjm_LxgGYeSKfL_H2Is'))); ?>";
