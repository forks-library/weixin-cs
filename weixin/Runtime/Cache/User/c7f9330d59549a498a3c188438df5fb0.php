...
<script type="text/javascript">
    ...
    // 微信授权
	window._wxAuthUrl = "<?php echo urlencode(base64_encode(U('/dgcs_wx/weixin.php/user/donation/payAction?id=ot7VhxPwYRRkgGu3CUiXASCYo4k0&no=120201806061611442199'))); ?>";
