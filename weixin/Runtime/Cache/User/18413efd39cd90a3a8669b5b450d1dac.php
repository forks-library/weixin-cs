...
<section class="main-container block" style="padding-top:7.2rem;padding-bottom:7rem; font-size:0px;">
	<!-- 头部 -->
...
<script type="text/javascript">
    ...
    // 微信授权
	window._wxAuthUrl = "<?php echo urlencode(base64_encode(U('/dgcs_wx/weixin.php/user/needhelp/detailMainCon?id=ot7VhxPwYRRkgGu3CUiXASCYo4k0&no=201706281145551514'))); ?>";
