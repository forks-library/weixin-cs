...
<!-- 没有数据时，隐藏封面 -->
<section class="main-container block" style="padding-top:3.5rem;padding-bottom:7rem; font-size:0px;">
	<!-- 头部 -->
...
<script type="text/javascript">
    ...
    // 微信授权
	window._wxAuthUrl = "<?php echo urlencode(base64_encode(U('/dgcs_wx/weixin.php/user/donation/detail?id=ot7VhxPwYRRkgGu3CUiXASCYo4k0&no=120201707251952593290'))); ?>";
