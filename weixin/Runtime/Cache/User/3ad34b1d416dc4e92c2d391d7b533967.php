...
<section class="main-container block" style="padding-top:6.5rem;padding-bottom:3.5rem; font-size:0px;">
	<!-- 头部 -->
	...
	<div class="article-twotitle">
		<div class="article-twotitle-txt ellipsis" style="padding-bottom: 0.3rem">我要求助</div>
...
<script type="text/javascript">
    ...
    // 微信授权
	window._wxAuthUrl = "<?php echo urlencode(base64_encode(U('/dgcs_wx/weixin.php/user/needhelp/index?id=ot7VhxPwYRRkgGu3CUiXASCYo4k0'))); ?>";
