		...
		<div class="activity-file-upload">
			...
			<div class="activity-uploadfile-cont">
				<!--div class="activity-uploadfile-btn">
					<img class="width100 height100" src="/dgcs_wx/Public/images/cf-certificates01.jpg" alt="" />
				</div-->
...
<script type="text/javascript">
    ...
    // 微信授权
	window._wxAuthUrl = "<?php echo urlencode(base64_encode(U('/dgcs_wx/weixin.php/home/activity/index?id=ot7VhxPwYRRkgGu3CUiXASCYo4k0'))); ?>";
